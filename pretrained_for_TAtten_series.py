...
def training(args):
    ...
    train_dataset = AllPhasesDataset_Pretrained(data_dir=args.train_data_dir, all_data_csv=args.all_data_csv,
                                                val_data_csv=args.val_data_csv,
                                                image_size=args.image_size, mode='train')
    valid_dataset = AllPhasesDataset_Pretrained(data_dir=args.train_data_dir, all_data_csv=args.all_data_csv,
                                                val_data_csv=args.val_data_csv,
        ...
        with torch.no_grad():
            for val_labed_img, val_unsup_img_list in valid_loader:
                ...
                for index in range(length):
                    ...
                    avloss_valid_mid += loss.item()
                avloss_valid_mid /= length
                avloss_valid += avloss_valid_mid
