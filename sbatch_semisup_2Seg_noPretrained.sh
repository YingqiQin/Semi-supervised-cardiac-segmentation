...
#SBATCH --output=semi_2Seg_noPretrained.out               # log output
...
python train_2Seg.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_noPretrained \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_noPretrained \
