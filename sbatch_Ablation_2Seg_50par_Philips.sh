...
#SBATCH --output=Ablation_2Seg_50par_Philips.out               # log output
...
python train_2Seg.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_2Seg_50par_Philips \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_2Seg_50par_Philips \
