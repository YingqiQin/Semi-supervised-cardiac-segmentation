...
#SBATCH --output=Ablation_2Seg_noaux_50par_Philips.out               # log output
...
python train_2Seg_no_auxloss.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_2Seg_noaux_50par_Philips \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_2Seg_noaux_50par_Philips \
