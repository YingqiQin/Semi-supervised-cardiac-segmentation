...
from MyDataSet import RandomPairs
...
def training(args):
    ...
    train_dataset = RandomPairs(data_dir=args.train_data_dir, unsup_data_csv=args.train_unsup_data_csv,
                                   sup_data_csv=args.train_sup_data_csv,
                                   image_size=args.image_size, mode='train')
    valid_dataset = RandomPairs(data_dir=args.train_data_dir, unsup_data_csv=args.valid_unsup_data_csv,
