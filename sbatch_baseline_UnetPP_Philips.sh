...
#SBATCH --output=UnetPP_Philips.out               # log output
...
python baseline_UNet++.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/UnetPP_Philips \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/UnetPP_Philips \
  --mode train