...
#SBATCH --output=semi_2Seg_4e_4.out               # log output
...
python train_2Seg.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_4e_4 \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_4e_4 \
