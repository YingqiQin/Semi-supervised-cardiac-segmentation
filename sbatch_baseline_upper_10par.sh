...
#SBATCH --output=baseline_Unet_upper_10par.out               # log output
...
python baseline_UNet.py \
  ...
  --train_data_list /home/fguo24/projects/def-ouriadov/fguo24/GuoLabStudents/yqin/Reg_Seg/pytorch/pytorch-deeplab_v3_plus/10parUpper_supervised_training.csv\
  --valid_data_list /home/fguo24/projects/def-ouriadov/fguo24/GuoLabStudents/yqin/Reg_Seg/pytorch/pytorch-deeplab_v3_plus/10parUpper_supervised_valid.csv \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Upper_10par \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Upper_10par \
  --mode train