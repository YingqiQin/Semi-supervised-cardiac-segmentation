...
#SBATCH --output=Ablation_TAtten_50par.out               # log output
...
python train_TAtten.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_TAtten_50par \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_TAtten_50par \
