...
#SBATCH --output=baseline_Unet_upper_Philips_20par.out               # log output
...
python baseline_UNet.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Upper_Philips_20par \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Upper_Philips_20par \
  --mode train