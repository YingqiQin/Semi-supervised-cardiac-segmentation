...
#SBATCH --output=UnetPP_Philips_20par.out               # log output
...
python baseline_UNet++.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/UnetPP_Philips_20par \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/UnetPP_Philips_20par \
  --mode train