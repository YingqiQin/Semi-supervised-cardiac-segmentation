...
#SBATCH --output=DeepAtlas_mixed.out               # log output
...
python DeepAtlas.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/DeepAtlas_50par_mixed \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/DeepAtlas_50par_mixed \
