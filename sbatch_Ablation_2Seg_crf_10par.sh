...
#SBATCH --output=Ablation_2Seg_crf_10par.out               # log output

source ../../../python3.7-pytorch1.7/bin/activate
python train_2Seg_crf.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_2Seg_crf \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_2Seg_crf \
