...
#SBATCH --output=DeepAtlas_MMM_10par.out               # log output
...
python DeepAtlas.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/DeepAtlas_10par_MMM \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/DeepAtlas_10par_MMM \
