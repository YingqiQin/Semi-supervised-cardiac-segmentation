...
#SBATCH --output=semi_2Seg_Tper.out               # log output

source ../../../python3.7-pytorch1.7/bin/activate
python train_2Seg_TPer.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_Tper \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_Tper \
