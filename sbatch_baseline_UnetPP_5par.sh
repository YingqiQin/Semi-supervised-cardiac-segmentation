...
#SBATCH --output=UnetPP_5par_mixed.out               # log output
...
python baseline_UNet++.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/UnetPP_5par_mixed \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/UnetPP_5par_mixed \
  --mode train