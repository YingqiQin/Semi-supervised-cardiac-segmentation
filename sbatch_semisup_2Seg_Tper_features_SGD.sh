...
#SBATCH --output=semi_2Seg_Tper_features_SGD.out               # log output

source ../../../python3.7-pytorch1.7/bin/activate
python train_2Seg_TPer_features_SGD.py \
  ...
  --TPer_state_dict_resume /home/fguo24/scratch/Reg_Seg/TPer/model/TPer.pth \
  --train_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_Tper_features_SGD \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_Tper_features_SGD \
