...
#SBATCH --output=baseline_Unet_5par_mixed.out               # log output
...
python baseline_UNet.py \
  ...
  --train_data_list /home/fguo24/projects/def-ouriadov/fguo24/GuoLabStudents/yqin/Reg_Seg/pytorch/pytorch-deeplab_v3_plus/5par_supervised_training_mixed.csv \
  --valid_data_list /home/fguo24/projects/def-ouriadov/fguo24/GuoLabStudents/yqin/Reg_Seg/pytorch/pytorch-deeplab_v3_plus/5par_supervised_valid_mixed.csv \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Lower_5par_mixed \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Lower_5par_mixed \
  --mode train