...
#SBATCH --output=UnetPP_mixed.out               # log output
...
python baseline_UNet++.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/UnetPP_mixed \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/UnetPP_mixed \
  --mode train