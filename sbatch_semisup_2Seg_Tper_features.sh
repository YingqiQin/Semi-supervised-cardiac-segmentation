...
#SBATCH --output=semi_2Seg_Tper_features.out               # log output

source ../../../python3.7-pytorch1.7/bin/activate
python train_2Seg_TPer_features.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_Tper_features \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_Tper_features \
