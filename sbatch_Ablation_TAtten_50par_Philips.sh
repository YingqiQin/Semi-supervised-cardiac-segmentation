...
#SBATCH --output=Ablation_TAtten_50par_Philips.out               # log output
...
python train_TAtten.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_TAtten_50par_Philips \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_TAtten_50par_Philips \
