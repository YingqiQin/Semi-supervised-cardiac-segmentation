...
#SBATCH --output=semi_with_aug.out               # log output

source ../../../python3.7-pytorch1.7/bin/activate
python train_with_augment.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/SemiSup_with_augment \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/SemiSup_with_augment \
