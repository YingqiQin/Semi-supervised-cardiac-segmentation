...
#SBATCH --output=semi_2Seg_TAtten_features_mixed.out               # log output
...
python train_2Seg_TAtten_features.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_TAtten_features_mixed \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_TAtten_features_mixed \
