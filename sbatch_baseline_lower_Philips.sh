...
#SBATCH --output=baseline_Unet_Philips.out               # log output
...
python baseline_UNet.py \
  ...
  --train_data_list /home/fguo24/projects/def-ouriadov/fguo24/GuoLabStudents/yqin/Reg_Seg/pytorch/pytorch-deeplab_v3_plus/supervised_training_Philips.csv \
  --valid_data_list /home/fguo24/projects/def-ouriadov/fguo24/GuoLabStudents/yqin/Reg_Seg/pytorch/pytorch-deeplab_v3_plus/supervised_training_Philips.csv \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Lower_Philips \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Lower_Philips \
  --mode train