...
#SBATCH --output=baseline_Unet_upper_Philips_20par_UnetPP.out               # log output
...
python baseline_UNet++.py \
  ...
  --train_data_list /home/fguo24/projects/def-ouriadov/fguo24/GuoLabStudents/yqin/Reg_Seg/pytorch/pytorch-deeplab_v3_plus/20par_all_training_Philips.csv \
  --valid_data_list /home/fguo24/projects/def-ouriadov/fguo24/GuoLabStudents/yqin/Reg_Seg/pytorch/pytorch-deeplab_v3_plus/20par_all_training_Philips.csv \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Upper_Philips_20par_UnetPP \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Baseline_Upper_Philips_20par_UnetPP \
  --mode train