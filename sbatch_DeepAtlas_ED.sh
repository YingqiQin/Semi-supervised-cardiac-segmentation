...
#SBATCH --output=DeepAtlas_ED.out               # log output
...
python DeepAtlas.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/DeepAtlas_50par_ED \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/DeepAtlas_50par_ED \
