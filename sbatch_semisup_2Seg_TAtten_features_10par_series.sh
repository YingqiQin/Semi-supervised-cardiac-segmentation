...
#SBATCH --output=semi_2Seg_TAtten_features_10par_series.out               # log output
...
python train_2Seg_TAtten_features_series.py \
  ...
  --val_data_csv /home/fguo24/projects/def-ouriadov/fguo24/GuoLabStudents/yqin/Reg_Seg/pytorch/pytorch-deeplab_v3_plus/10par_supervised_valid.csv \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_TAtten_features_10par_series \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_TAtten_features_10par_series \
