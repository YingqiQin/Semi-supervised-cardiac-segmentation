...
#SBATCH --output=Ablation_2Seg_50par.out               # log output
...
python train_2Seg.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_2Seg_50par \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/Ablation_2Seg_50par \
