...
#SBATCH --output=semi_2Seg_TAtten_features_10par.out               # log output
...
python train_2Seg_TAtten_features.py \
  ...
  --train_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_TAtten_features_10par \
  --test_output_dir /home/fguo24/scratch/Reg_Seg/semi_2Seg_TAtten_features_10par \
